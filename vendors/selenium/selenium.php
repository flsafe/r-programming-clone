<?php
#PHP DRIVER 1.0.1
#Used with selenium server 1.0.3
 ...
 * NOTE: I've changed what the files that the selenium
 * php drivers used. I've changed the main 'Selenium.php' file
 * to 'selenium.php' because App::import wasn't loading 'Selenium.php'.
 * Also I've changed what 'Selenium/Exception.php' imports.
 * I commented out 'require_once('PEAR/Exception.php') 
 * and just had 'Selenium/Exception.php' extend from Exception. -Frank March 2010
 */
