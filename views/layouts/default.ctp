...
<body>
	...
	<div id="sidebar">
		<p>
			CodeKettl is the funnest way to practice your programming skills and learn from other programers.
		</p>
		<p>
			...
			?>
			<div id="add">
				Your advertisement or job listing could be here! Details coming soon.
